            ...
            <div class="grid grid-cols-12 gap-6 md:gap-8">
                <div class="col-span-12 lg:col-span-9 space-y-6">
                    <div class="bg-surface-container-low p-4 rounded-3xl flex flex-wrap items-center gap-4">
                        <form method="GET" class="flex items-center gap-2 bg-surface-container px-4 py-2 rounded-2xl">
                        ...
                        <div class="flex items-center gap-2 bg-surface-container px-4 py-2 rounded-2xl">
                            ...
                            <select aria-label="Filter projects by client"
                                class="bg-transparent border-none text-sm p-0 focus:ring-0 text-primary font-medium cursor-pointer">
                        ...
                        <div class="flex items-center gap-2 bg-surface-container px-4 py-2 rounded-2xl">
                            ...
                            <select aria-label="Sort projects by"
                                class="bg-transparent border-none text-sm p-0 focus:ring-0 text-primary font-medium cursor-pointer">
                                                ...
                                                <div class="flex -space-x-2">
                                                    @foreach($project->team()->limit(3)->get() as $member)
                                                        <img class="w-8 h-8 rounded-full border-2 border-surface-container-low object-cover"
                                                            alt="Team" src="https://ui-avatars.com/api/?name={{ urlencode($member->user?->name ?? 'U') }}&background=818cf8&color=fff" />
                                                    @endforeach
                            ...
                            @forelse($recentProjects as $recent)
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-xs text-on-surface-variant">{{ $recent->updated_at->diffForHumans() }}</p>
                                    </div>
                                </div>
                            @empty
